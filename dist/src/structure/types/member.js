...
exports.MemberArgumentType = void 0;
const base_1 = require("./base");
const util_1 = require("../util");
const discord_js_1 = require("discord.js");
class MemberArgumentType extends base_1.ArgumentType {
    constructor(client) {
        super(client, 'member');
    }
    async validate(val, msg, arg) {
        ...
        return members.size <= 15 ?
            `${util_1.disambiguation(members.map(mem => `${discord_js_1.Util.escapeMarkdown(mem.user.username)}#${mem.user.discriminator}`), 'members', null)}\n` :
...
exports.MemberArgumentType = MemberArgumentType;
