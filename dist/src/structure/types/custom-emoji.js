...
exports.CustomEmojiArgumentType = void 0;
const base_1 = require("./base");
const util_1 = require("../util");
const discord_js_1 = require("discord.js");
class CustomEmojiArgumentType extends base_1.ArgumentType {
    constructor(client) {
    ...
    validate(value, msg) {
        ...
        return emojis.size <= 15 ?
            `${util_1.disambiguation(emojis.map(emoji => discord_js_1.Util.escapeMarkdown(emoji.name)), 'emojis', null)}\n` :
...
exports.CustomEmojiArgumentType = CustomEmojiArgumentType;
