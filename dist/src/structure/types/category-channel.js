...
class CategoryChannelArgumentType extends base_1.ArgumentType {
    constructor(client) {
    ...
    validate(val, msg, arg) {
        ...
        return channels.size <= 15
            ? `${util_1.disambiguation(channels.map((chan) => discord_js_1.Util.escapeMarkdown(chan.name)), "categories", null)}\n`
