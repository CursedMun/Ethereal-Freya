...
exports.RoleArgumentType = void 0;
const base_1 = require("./base");
const util_1 = require("../util");
const discord_js_1 = require("discord.js");
class RoleArgumentType extends base_1.ArgumentType {
    constructor(client) {
        super(client, 'role');
    }
    validate(val, msg, arg) {
        ...
        return roles.size <= 15 ?
            `${util_1.disambiguation(roles.map(role => `${discord_js_1.Util.escapeMarkdown(role.name)}`), 'roles', null)}\n` :
...
exports.RoleArgumentType = RoleArgumentType;
