...
exports.TextChannelArgumentType = void 0;
const base_1 = require("./base");
const util_1 = require("../util");
const discord_js_1 = require("discord.js");
class TextChannelArgumentType extends base_1.ArgumentType {
    constructor(client) {
    ...
    validate(val, msg, arg) {
        ...
        return channels.size <= 15 ?
            `${util_1.disambiguation(channels.map(chan => discord_js_1.Util.escapeMarkdown(chan.name)), 'text channels', null)}\n` :
...
exports.TextChannelArgumentType = TextChannelArgumentType;
