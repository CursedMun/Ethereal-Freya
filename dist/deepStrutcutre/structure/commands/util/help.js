    ...
    async run(msg, args) {
        ...
        if (args.command && !showAll) {
            if (commands.length === 1) {
                ...
                return msg.reply(`Unable to identify command. Use ${msg.usage(null, msg.channel.type === 'dm' ? null : undefined, msg.channel.type === 'dm' ? null : undefined)} to view the list of all commands.`);
            }
        }
        else {
            const messages = [];
