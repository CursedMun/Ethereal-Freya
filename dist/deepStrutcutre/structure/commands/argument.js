...
class Argument {
    ...
    validate(val, originalMsg, currentMsg = originalMsg) {
        ...
        const valid = this.validator ?
            ...
            (_a = this.type) === null || _a === void 0 ? void 0 : _a.validate(val, originalMsg, this, currentMsg);
    ...
    parse(val, originalMsg, currentMsg = originalMsg) {
        ...
        return (_a = this.type) === null || _a === void 0 ? void 0 : _a.parse(val, originalMsg, this, currentMsg);
    }
